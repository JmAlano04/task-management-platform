 @forelse ($users as $user)
                <tr class="hover:bg-secondary-light transition duration-150 ease-in-out">
                    <td class="px-4 py-3 whitespace-nowrap text-xs">{{ $user->id }}</td>
                    <td class="px-4 py-3 whitespace-nowrap text-xs">{{ $user->name }}</td>
                    <td class="px-4 py-3 whitespace-nowrap text-xs">{{ $user->email }}</td>
                    <td class="px-4 py-3 whitespace-nowrap text-xs">{{ $user->role }}</td>
